...
class _NotificationSettingsPageState extends State<NotificationSettingsPage> {
  ...
  Future<void> _loadPreferences() async {
    ...
    if (mounted) {
      setState(() {
        _readingReminders =
            prefs.getBool(PreferencesNotifications.cleRappelsLecture) ?? true;
        _newChapters =
            prefs.getBool(PreferencesNotifications.cleCommunaute) ?? true;
        _salesReminders =
            prefs.getBool(PreferencesNotifications.cleVentes) ?? true;
        _isLoading = false;
      });
    }
  }
                      ...
                      children: [
                        SwitchListTile(
                          ...
                          onChanged: (val) {
                            ...
                            _savePreference(
                              PreferencesNotifications.cleRappelsLecture,
                              val,
                            );
                        ...
                        SwitchListTile(
                          ...
                          onChanged: (val) {
                            ...
                            _savePreference(
                              PreferencesNotifications.cleCommunaute,
                              val,
                            );
                            AppNotifications.showSnackBar(
                              context,
                              message:
                                  "Préférences de nouveautés mises à jour.",
                              isSuccess: true,
                            );
                          },
                        ),
                      ...
                      children: [
                        SwitchListTile(
                          ...
                          onChanged: (val) {
                            ...
                            _savePreference(
                              PreferencesNotifications.cleVentes,
                              val,
                            );
                            AppNotifications.showSnackBar(
                              context,
