        ...
        children: [
          ...
          Card(
            ...
            child: Column(
              children: [
                SwitchListTile(
                  title: Text("Partager les statistiques d'utilisation", style: GoogleFonts.poppins(fontWeight: FontWeight.bold, color: isDark ? Colors.white : Colors.black87, fontSize: 14)),
                  subtitle: Text("Nous aide à améliorer l'application en collectant des données de crash anonymes.", style: GoogleFonts.poppins(color: isDark ? Colors.white70 : Colors.black54, fontSize: 12)),
                ...
                SwitchListTile(
                  title: Text("Recommandations personnalisées", style: GoogleFonts.poppins(fontWeight: FontWeight.bold, color: isDark ? Colors.white : Colors.black87, fontSize: 14)),
                  subtitle: Text("Permet de vous proposer des livres adaptés à vos habitudes de lecture.", style: GoogleFonts.poppins(color: isDark ? Colors.white70 : Colors.black54, fontSize: 12)),
