            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      // Prevent the parent card tap (which opens book details / payment)
                      // from firing when the author name is tapped.
                      // If there's an Author page, navigate to it here. Otherwise show a quick info.
                      // TODO: replace SnackBar with navigation to author profile when available.
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Auteur : ${book.authorName}')),
                      );
                    },
                    child: Text(
                      book.authorName,
